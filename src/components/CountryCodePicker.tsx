...
const countries = [
  ...
  { label: "Bermuda (+1-441)", value: "1241" },
  ...
  { label: "Dominican Republic (+1-809, +1-829, +1-849)", value: "1809" },
  ...
  { label: "Puerto Rico (+1-787, +1-939)", value: "1787" },
...
export function CountryCodePicker({ value, onSelect }: CountryCodePickerProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[300px] p-0 bg-card border-none shadow-2xl rounded-[20px]">
            ...
            <CommandGroup>
              {countries.map((country) => (
                <CommandItem
                  ...
                  className="py-3 px-4 aria-selected:bg-accent aria-selected:text-white cursor-pointer"
                >
                  <Check
                    className={cn(
                      "mr-2 h-4 w-4",
